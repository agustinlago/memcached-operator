...
import (
	...
	cachev1alpha1 "github.com/agustinlago/memcached-operator/api/v1alpha1"
)

const memcachedFinalizer = "cache.alago.com/finalizer"
...
//+kubebuilder:rbac:groups=cache.alago.com,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cache.alago.com,resources=memcacheds/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cache.alago.com,resources=memcacheds/finalizers,verbs=update
